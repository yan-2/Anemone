<template>
  <div class="flex justify-center items-center mt-3">
    ...
    <div
      class="carousel flex justify-start items-center w-[160vh] mr-5 ml-5 overflow-hidden max-sm:w-[30vh] 2xl:w-[90%]"
      ref="carousel"
    >
      <div
        class="inner w-[35%] transition-transform duration-300 whitespace-nowrap max-sm:w-[90%] sm:w-[25%] lg:w-[30%] lg:ml-10 xl:w-[25%] 2xl:w-[40%]"
        ref="inner"
        :style="innerStyles"
      >
