<template>
  <div class="w-full max-w-7xl mx-auto px-4 text-primary">
    ...
    <Carousel v-show="services.length != 0 && !loading" v-bind="settings" :breakpoints="breakpoints" class="md:max-w-6xl mx-auto" :autoplay="2000" :wrap-around="true">
          ...
          <div class="border border-primary lg:p-3 sm:p-0 pb-2 bg-white lg:ml-2 mr-2 relative box-equal-size">
            ...
            <div class="flex justify-center p-4">
              <NuxtImg :src="item.pic" 
                      ...
                      :alt=" 'This image represents the ' + item.name + ' service'"
                      />
            </div>
            <div>
